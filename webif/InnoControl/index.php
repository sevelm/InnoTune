...
<div class="innocontrol-layout mdl-layout mdl-js-layout mdl-layout--fixed-drawer mdl-layout--fixed-header">
    <header class="demo-header mdl-layout__header mdl-color--grey-100 mdl-color-text--grey-600">
        <div class="mdl-layout__header-row">
            ...
            <a ng-show="audioConfChanged=='1'" ng-click="genAudioConf($event)" class="mdl-button mdl-button--colored mdl-js-button mdl-js-ripple-effect mdl-cell--hide-phone" style="right: 20%; color: red">
               Der Server muss neu gestartet werden!
            </a>
            <a href="/old" class="mdl-button mdl-button--colored mdl-js-button mdl-js-ripple-effect mdl-cell--hide-phone ">
            ...
            <ul class="mdl-menu mdl-js-menu mdl-js-ripple-effect mdl-menu--bottom-right" for="verticalmenu">
                <a style="text-decoration: none" href="http://www.innotune.at/kontakt/">
                    <li class="mdl-menu__item">Kontakt</li>
                </a>
                <a style="text-decoration: none" href="http://www.innotune.at/">
    ...
    <div class="demo-drawer mdl-layout__drawer mdl-color--blue-grey-900 mdl-color-text--blue-grey-50">
        <header class="demo-drawer-header">
            <div class="mdl-layout-spacer"></div>
            <img src="images/innocontrol.png" class="unselectable" style="height: 45%; width: 100%;">
            <div class="mdl-layout-spacer"></div>
        </header>
        <nav class="demo-navigation mdl-navigation mdl-color--blue-grey-800">
            <a id="homeanchor" name="routeanchors" class="mdl-navigation__link" href="#home"><i class="mdl-color-text--blue-grey-400 material-icons"
                                                            role="presentation">home</i>Home</a>
            <a id="devicesanchor" name="routeanchors" class="mdl-navigation__link" href="#devices"><i class="mdl-color-text--blue-grey-400 material-icons"
                                                               role="presentation">usb</i>InnoAmp's</a>
            <a id="volumemixeranchor" name="routeanchors" class="mdl-navigation__link" href="#volumemixer"><i class="mdl-color-text--blue-grey-400 material-icons"
                                                                   role="presentation">volume_up</i>Lautstärke</a>
            <a id="lineinanchor" name="routeanchors" class="mdl-navigation__link" href="#linein"><i class="mdl-color-text--blue-grey-400 material-icons"
                                                              role="presentation">settings_input_component</i>Line-In</a>
            <a id="mpdanchor" name="routeanchors" class="mdl-navigation__link" href="#mpd"><i class="mdl-color-text--blue-grey-400 material-icons"
                                                           role="presentation">speaker_group</i>Player Zentral</a>
            <a id="voiceoutputanchor" name="routeanchors" class="mdl-navigation__link" href="#voiceoutput"><i class="mdl-color-text--blue-grey-400 material-icons"
                                                                   role="presentation">record_voice_over</i>Sprachausgabe</a>
            <a id="docsanchor" name="routeanchors" class="mdl-navigation__link" href="#docs"><i class="mdl-color-text--blue-grey-400 material-icons"
                                                            role="presentation">system_update_alt</i>Dokumente</a>
            <div class="mdl-layout-spacer"></div>
            <a id="settingsanchor" name="routeanchors" class="mdl-navigation__link" href="#settings"><i class="mdl-color-text--blue-grey-400 material-icons"
