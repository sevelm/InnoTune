...
<div class="mdl-grid">
    ...
    <div class="mdl-grid mdl-cell--6-col" style="height: 0">
        ...
        <div class="demo-card-wide mdl-card mdl-shadow--2dp mdl-cell mdl-cell--top mdl-cell--12-col" ng-init="checkVPNConnection()">
                ...
                <div class="mdl-card__supporting-text">
                    ...
                    <!--<h5>Zertifikate für Fernzugriff in InnoTune importieren.</h5>
                    Wichtig! Dateiname: <b>certs.zip</b>
                    <?php
                        /*if (isset($_GET['result'])) {
                            if ($_GET['result'] == "erfolgreich") {
                                echo "Die Zertifikate wurden erfolgreich importiert.";
                            } else {
                                echo "Fehler beim Hochladen der Zertifikate!";
                            }
                        }*/
                    ?>
                    <br/>
                    <br>
                    <div class="mdl-card__actions mdl-card--border">
                        <form enctype="multipart/form-data" action="scripts/upload.php?certs_upload" method="POST">
                            <input type="hidden" name="MAX_FILE_SIZE" value="512000"/>
                            <label class="mdl-button">
                                <input name="userfile" id="userfile" type="file" accept="certs.zip" ng-click="certsupload=1"/>
                                Zertifikate importieren
                            </label>
                            <span id="display-text"></span>
                            <button id="certs_upload" type="submit" disabled name="certs_upload" value="Hochladen"
                                    class="mdl-button mdl-button--colored mdl-js-button mdl-js-ripple-effect">Hochladen
                            </button>
                        </form>
                    </div>-->
                    <!--<div class="mdl-grid">
                        <p class="mdl-cell ">Privater Schlüssel</p>
                        <md-input-container class="md-block mdl-cell settingsW">
                            <input ng-model="private_key" aria-label="private_key">
                        </md-input-container>
                    </div>-->
                </div>
                <div class="mdl-card__actions mdl-card--border">
                    ...
                    <!--<button ng-click="savePrivateKey()"
                            class="mdl-button mdl-button--colored mdl-js-button mdl-js-ripple-effect">
                        Speichern
                    </button>-->
                </div>
...
<!--<script type="application/javascript">
    document.getElementById('userfile').onchange = function () {
        ...
        document.getElementById('certs_upload').disabled = document.getElementById('userfile').value.split(/(\\|\/)/g).pop().trim() !== "certs.zip";
    }
</script>-->
