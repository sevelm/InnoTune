...
<div ng-init="getNetworkSettings()" class="demo-card-wide mdl-card mdl-shadow--2dp mdl-cell mdl-cell--6-col">
    ...
    <div class="mdl-card__supporting-text">
        <ng-form name="networkForm">
            ...
            <span ng-show="networkForm.subnetmask.$error.pattern" style="color:red">Subnetmask ist nicht möglich!</span>
            ...
            <span ng-show="networkForm.dns1.$error.pattern" style="color:red">IP Adresse ist nicht möglich!</span>
            ...
            <span ng-show="networkForm.dns2.$error.pattern" style="color:red">IP Adresse ist nicht möglich!</span>
