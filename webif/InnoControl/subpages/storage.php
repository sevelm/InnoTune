...
<div class="mdl-grid">
    ...
    <div class="mdl-cell mdl-cell--6-col">
        ...
        <div ng-init="getNetworkMount()" class="demo-card-wide mdl-card mdl-shadow--2dp mdl-cell mdl-cell--top mdl-cell--12-col">
    ...
    <div class="mdl-cell mdl-cell--6-col">
        ...
        <div ng-init="getMountInfo()"
             class="demo-card-wide mdl-card mdl-shadow--2dp mdl-cell mdl-cell--top mdl-cell--12-col">
            <div class="mdl-card__title">
                <h2 class="mdl-card__title-text">Usb-Mount Geräteinfo</h2>
            </div>

            <div class="mdl-card__supporting-text">
                <h5>Festplatte sicher aushängen</h5>
                <div class="mdl-grid">
                    <p class="mdl-cell mdl-cell--2-col">Festplatte:</p>

                    <md-select placeholder="" ng-model="mount_dropdown_selection.path"
                               ng-change="mount_dropdown_selection.path"
                               class="mdl-cell mdl-cell--4-col md-no-underline" style="color: #545454"
                               aria-label="drive">
                        <md-option ng-repeat="drive in mount_dropdown" value="{{drive.path}}">{{drive.name}}</md-option>
                    </md-select>

                    <button ng-click='unmountDrive()' class="mdl-cell mdl-cell--3-col mdl-button mdl-button--colored mdl-js-button mdl-js-ripple-effect" >
                        Aushängen
                    </button>
                </div>
            ...
            <div class="mdl-card__actions mdl-card--border">
              <button ng-click='getMountInfo()' class="mdl-button mdl-button--colored mdl-js-button mdl-js-ripple-effect" >
                  Aktualisieren
              </button>
            </div>
            ...
            <div class="mdl-card__menu">
                <button class="mdl-button mdl-button--icon mdl-js-button mdl-js-ripple-effect">
                    <i class="material-icons">info</i>
                    <md-tooltip md-direction="bottom">
                        Zeigt Infos zu erkannten Festplatten/USB-Sticks an und welche davon im System eingebunden sind.
                    </md-tooltip>
                </button>
            </div>
        </div>
