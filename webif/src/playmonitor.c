...
#
# Funktion:
# 1. Einlesen ob Airplay gerade l�uft von /opt/innotune/settings/status_shairplay/status_shairplayXX.txt -> Wenn dies Gr��er 0, dann
# 2. Master Lautst�rkenregler f�r alle Quellen nach Airplay 0%
# 4. Wenn Airplay nicht mehr l�uft /opt/innotune/settings/status_shairplay/status_shairplayXX.txt -> Wenn dies kleiner gleich 0, dann
# 5. Master Lautst�rkenregler f�r alle Quellen nach Airplay 100%
#
# Anwendung:
# Andere Quellen mute w�hrend Airplay aktiv
#
*/
