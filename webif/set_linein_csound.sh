...
#
#                     ACHTUNG
# Dieses Skript wird nicht mehr verwendet.
# Das aktuell genutzte LineIn-Skript ist "set_linein.sh"
# 
#
#
##########################################################
...
if [[ $card_in ]]; then
      ...
      amixer -c $card_out set MuteIfLineInre_$card_out 1%
        ...
        if [ "$zone2" == "2" ]; then
              # csound.csd file f�r den linken kanal erzeugen und starten
              ...
              # csound.csd file f�r den rechten kanal erzeugen und starten
